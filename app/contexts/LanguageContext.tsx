  ...
  const t = (key: string): string => {
    const translations: Record<Language, Record<string, string>> = {
      zh: {
        ...
        // Product Case Items
        'case.engineering.parts': '工程塑料部件',
        'case.electronic.components': '电子元件',
        'case.auto.parts': '汽车零部件',
        'case.garbage.bag': '垃圾袋',
        'case.garment.bag': '服装袋',
        'case.agricultural.film': '农地膜',
        'case.food.film': '食品包装膜',
        'case.thermoformed.box': '吸塑包装盒',
        'case.meal.box': '餐盒',
        'case.medicine.packaging': '药瓶包装',
        'case.cosmetic.packaging': '化妆品包装',
        'case.waterproof.film': '工程防水膜',
        'case.hygiene.products': '卫生用品',
        'case.water.system': '给排水系统',
        'case.gas.pipeline': '天然气输送管道',
        'case.industrial.pipeline': '工业管道',
        'case.plastic.pipe': '塑料管材',
        'case.electronic.casing': '电子电器外壳',
        'case.packaging.materials': '包装材料',
        'case.white.plastic': '白色塑料件',
        'case.appliance.casing': '家电外壳',
        'case.medical.devices': '医疗器械',
        'case.toys': '玩具',
        'case.daily.products': '日用品',
        'case.electronics': '电子外壳',
        'case.sheets': '板材',
        'case.profiles': '型材',
        'case.film.products': '薄膜制品',
        'case.electronic.packaging': '电子包装',
        'case.medical.supplies': '医疗用品',
      ...
      en: {
        ...
        'back': 'Back',
        'concept.intro': 'Concept Introduction',
        'product.cases': 'Product Cases',

        // Product Case Items
        'case.engineering.parts': 'Engineering Plastic Parts',
        'case.electronic.components': 'Electronic Components',
        'case.auto.parts': 'Automotive Parts',
        'case.garbage.bag': 'Garbage Bags',
        'case.garment.bag': 'Garment Bags',
        'case.agricultural.film': 'Agricultural Films',
        'case.food.film': 'Food Packaging Films',
        'case.thermoformed.box': 'Thermoformed Packaging Boxes',
        'case.meal.box': 'Meal Boxes',
        'case.medicine.packaging': 'Medicine Bottle Packaging',
        'case.cosmetic.packaging': 'Cosmetic Packaging',
        'case.waterproof.film': 'Engineering Waterproof Films',
        'case.hygiene.products': 'Hygiene Products',
        'case.water.system': 'Water Supply & Drainage Systems',
        'case.gas.pipeline': 'Natural Gas Pipelines',
        'case.industrial.pipeline': 'Industrial Pipes',
        'case.plastic.pipe': 'Plastic Pipes',
        'case.electronic.casing': 'Electronic Casings',
        'case.packaging.materials': 'Packaging Materials',
        'case.white.plastic': 'White Plastic Parts',
        'case.appliance.casing': 'Appliance Casings',
        'case.medical.devices': 'Medical Devices',
        'case.toys': 'Toys',
        'case.daily.products': 'Daily Products',
        'case.electronics': 'Electronic Casings',
        'case.sheets': 'Sheets',
        'case.profiles': 'Profiles',
        'case.film.products': 'Film Products',
        'case.electronic.packaging': 'Electronic Packaging',
        'case.medical.supplies': 'Medical Supplies',
      ...
      vi: {
        ...
        'back': 'Quay lại',
        'concept.intro': 'Giới thiệu khái niệm',
        'product.cases': 'Ví dụ sản phẩm',

        // Product Case Items
        'case.engineering.parts': 'Chi tiết nhựa kỹ thuật',
        'case.electronic.components': 'Linh kiện điện tử',
        'case.auto.parts': 'Phụ tùng ô tô',
        'case.garbage.bag': 'Túi rác',
        'case.garment.bag': 'Túi quần áo',
        'case.agricultural.film': 'Phim nông nghiệp',
        'case.food.film': 'Phim đóng gói thực phẩm',
        'case.thermoformed.box': 'Hộp đóng gói hút chân không',
        'case.meal.box': 'Hộp cơm',
        'case.medicine.packaging': 'Đóng gói chai thuốc',
        'case.cosmetic.packaging': 'Đóng gói mỹ phẩm',
        'case.waterproof.film': 'Phim chống thấm kỹ thuật',
        'case.hygiene.products': 'Sản phẩm vệ sinh',
        'case.water.system': 'Hệ thống cấp thoát nước',
        'case.gas.pipeline': 'Đường ống khí đốt tự nhiên',
        'case.industrial.pipeline': 'Ống công nghiệp',
        'case.plastic.pipe': 'Ống nhựa',
        'case.electronic.casing': 'Vỏ thiết bị điện tử',
        'case.packaging.materials': 'Vật liệu đóng gói',
        'case.white.plastic': 'Chi tiết nhựa trắng',
        'case.appliance.casing': 'Vỏ thiết bị gia dụng',
        'case.medical.devices': 'Thiết bị y tế',
        'case.toys': 'Đồ chơi',
        'case.daily.products': 'Sản phẩm hàng ngày',
        'case.electronics': 'Vỏ thiết bị điện tử',
        'case.sheets': 'Tấm',
        'case.profiles': 'Thanh',
        'case.film.products': 'Sản phẩm phim',
        'case.electronic.packaging': 'Đóng gói điện tử',
        'case.medical.supplies': 'Vật dụng y tế',
